...
export class GoogleComponent extends Component {
  ...
  getInfo(param) {
    ...
    if (this.props.apiKey) {
      ...
      let _fire = fetch('https://maps.googleapis.com/maps/api/place/autocomplete/json?input=' +
        param + '&' + _lang + _co + '&key=' + this.props.apiKey,requestOptions
      )
  ...
  getCoordinates(address) {
    if (this.props.apiKey) {
      let _fire = fetch('https://maps.googleapis.com/maps/api/geocode/json?address=' + address + '&key=' + this.props.apiKey,requestOptions)
  ...
  getCurrentLocation() {
    if (this.props.apiKey) {
      navigator.geolocation.getCurrentPosition((location) => {
        ...
        let _fire = fetch('https://maps.googleapis.com/maps/api/geocode/json?' + obj + '&key=' + this.props.apiKey,requestOptions
        )
        return _fire.then((resp) => {
          return resp.json().then((res) => {
